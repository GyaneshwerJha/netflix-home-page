...
const apiKey = 'fb60c0324906398aa1b78fc817bc4e86';
    ...
    return (
        <section className="home">
            <div className="banner" style={{ backgroundImage: popularMovies[0] ? `url(${imgUrl}/${popularMovies[0].poster_path})` : "rgb(16, 16, 16)" }}>
                <h1>{popularMovies[0]?.original_title ? popularMovies[0]?.original_title : "none"}</h1>
                <p>{popularMovies[0]?.overview ? popularMovies[0]?.overview : "none"}</p>
            ...
            <Row title={'Popular trends'} arr={popularMovies} />
